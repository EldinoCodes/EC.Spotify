...
{
    /// <summary>
    /// Creates a new playlist for the current user asynchronously.
    /// </summary>
    /// <remarks>Requires the <c>playlist-modify-public</c> and <c>playlist-modify-private</c> scopes.</remarks>
    /// <param name="playlistCreate">The playlist details to use for creation. Cannot be null.</param>
    /// <param name="cancellationToken">A cancellation token that can be used to cancel the asynchronous operation.</param>
    /// <returns>A task that represents the asynchronous operation. The task result contains a <see cref="SpotifyResult{Playlist}"/>
    /// with the created playlist details.</returns>
    Task<SpotifyResult<Playlist>> PlaylistCreateAsync(PlaylistCreate playlistCreate, CancellationToken cancellationToken = default);
    /// <summary>
