...
/// <summary>
/// Represents a single page of results from a paginated Spotify API response containing polymorphic items
/// such as albums, artists, tracks, or episodes.
/// </summary>
public class SpotifyPolymorphicPageResult
{
