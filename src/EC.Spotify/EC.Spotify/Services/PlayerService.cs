...
internal sealed class PlayerService(ILogger<PlayerService> logger, IOptions<SpotifyOptions> options, ISpotifyProvider spotifyProvider) : IPlayerService
{
    ...
    public async Task<SpotifyResult<bool>> PlayAsync(string? deviceId, List<string>? trackUris, CancellationToken cancellationToken = default)
    {
        try
        {
            var error = _options.ValidateScopes(["user-modify-playback-state"]);
    ...
    public async Task<SpotifyResult<bool>> NextAsync(string? deviceId = null, CancellationToken cancellationToken = default)
    {
        try
        {
            var error = _options.ValidateScopes(["user-modify-playback-state"]);
    ...
    public async Task<SpotifyResult<bool>> PreviousAsync(string? deviceId = null, CancellationToken cancellationToken = default)
    {
        try
        {
            var error = _options.ValidateScopes(["user-modify-playback-state"]);
    ...
    public async Task<SpotifyResult<bool>> RepeatAsync(PlayerRepeatMode playerRepeatMode = PlayerRepeatMode.Off, string? deviceId = null, CancellationToken cancellationToken = default)
    {
        try
        {
            var error = _options.ValidateScopes(["user-modify-playback-state"]);
    ...
    public async Task<SpotifyResult<bool>> VolumeAsync(int volumePercent, string? deviceId = null, CancellationToken cancellationToken = default)
    {
        try
        {
            var error = _options.ValidateScopes(["user-modify-playback-state"]);
    ...
    public async Task<SpotifyResult<bool>> ShuffleAsync(PlayerShuffleMode playerShuffleMode = PlayerShuffleMode.Off, string? deviceId = null, CancellationToken cancellationToken = default)
    {
        try
        {
            var error = _options.ValidateScopes(["user-modify-playback-state"]);
